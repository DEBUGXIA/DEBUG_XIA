  ...
  return (
    <div className=' flex flex-col items-center justify-between gap-2 w-1/4 ml-10 -mt-80'>
        ...
        <div className=' flex flex-row items-center justify-between gap-1 px-2 py-1'>
            <div>
              <h1 className='text-gray-400 font-medium text-lg tracking-wide'>Shradha Khapra .</h1>
            </div>
            <div>
              <h1 className='text-gray-400 font-normal text-xs tracking-wide'>She/Her</h1>
            </div>
        </div>

        <div className=''>
            <p className='text-gray-400 font-medium text-sm tracking-wide px-2 py-1'>
              No.1 for online Tech Placements & Internships Thousands of students Placed 🚀 7 Million+ Coders on YouTube
            </p>
        </div>

        <div className=' border-2 border-gray-500 rounded-xl text-gray-400 py-1 px-4 tracking-wide'>
            <button className='text-gray-400 font-normal text-sm tracking-wide'><Link to='/Edit_Profile'>Edit Profile Picture</Link></button>
        </div>
