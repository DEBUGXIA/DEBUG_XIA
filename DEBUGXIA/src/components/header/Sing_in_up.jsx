...
const Sing_in_up = () => {
  return (
      ...
      <div className='list-none flex items-center flex-row justify-end gap-10 absolute right-10 text-base font-semibold tracking-wide'>
        ...
        <button className=' text-white py-1.5 px-4 text-lg font-semibold rounded-2xl tracking-wide bg-gradient-to-r from-blue-500 to-sky-300 text-white'><Link to='/Get_Started'>Get Started</Link></button>
    </div>
  )
}
