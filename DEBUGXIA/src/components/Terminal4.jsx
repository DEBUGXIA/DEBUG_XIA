...
import { Zap, CodeXml, Trash2 } from 'lucide-react'
    ...
    <div className='m-10 flex flex-row justify-between gap-10 text-gray-300 px-30 py-10'>
      <form className='flex-col w-2/3 gap-5 justify-between bg-gray-950 border-1 border-gray-500 rounded-2xl p-5' onSubmit={(e) =>{SubmitHandler(e)}} action="">
         ...
         <div className='flex flex-col gap-5 justify-between border-white rounded-md'>
          ...
          <textarea placeholder='Paste Your Code . . . ' name="" id=""className='bg-gray-950 px-5 py-2 font-semibold text-lg tracking-wide border-gray-700 rounded-md border-1 h-80'value={details} onChange={(e) => {setDetails(e.target.value)}}></textarea>
  
          <div className='flex flex-row items-center justify-between '>
            <button className=' text-white px-4 py-2 font-semibold text-lg tracking-wide rounded-xl w-180 text-center bg-gradient-to-r from-blue-500 to-cyan-400 flex flex-row items-center justify-center gap-3'>
              <div><Zap color="#ffffff" strokeWidth={1.75} /></div>
              <div><h1>Generated Optimize Suggestion</h1></div>
            </button>
      ...
      <div className=' flex flex-wap flex-col justify-start p-2 w-1/3 h-150 gap-2 bg-gray-950 border-1 border-gray-500 rounded-2xl p-5'>
        ...
        <div className='border-2 border-gray-800 rounded-md w-full h-[94%] p-2 bg-gray-950'>
          <div className=''>
