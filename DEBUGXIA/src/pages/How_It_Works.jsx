      ...
      <div className=' flex flex-col items-center justify-between gap-20 w-[100%] aspect-[16/9]'>
        ...
        <div>
          ...
          <div className=' flex flex-row items-center justify-between w-200'>
            <div className=' rounded-2xl bg-white/5 backdrop-blur-xl shadow-2xl py-5 px-5'><CodeXml color="#609ee2" strokeWidth={1.5} /></div>
            <div className=' rounded-2xl bg-white/5 backdrop-blur-xl shadow-2xl py-5 px-5'><TriangleAlert color="#609ee2" strokeWidth={1.5} /></div>
            <div className=' rounded-2xl bg-white/5 backdrop-blur-xl shadow-2xl py-5 px-5'><Cpu color="#609ee2" strokeWidth={1.5} /></div>
            <div className=' rounded-2xl bg-white/5 backdrop-blur-xl shadow-2xl py-5 px-5'><CircleCheck color="#609ee2" strokeWidth={1.5} /></div>
          </div>
        ...
        <div className=' -mt-17 flex flex-row items-center justify-between w-230'>

            <div className=' flex flex-col items-center justify-between'>
              <h1 className=' text-lg tracking-wide font-medium'>Write Code</h1>
              <p className='font-medium text-base text-gray-300'>Developer writes code in VS<br></br><span className=' ml-10'>Code as usual.</span></p>
            </div>
            <div className=' flex flex-col items-center justify-between'>
          ...
          <div className=' flex items-center py-5 px-50'>
            <img src="/public/How_It_Work.svg" alt=""  className='border-2 border-gray-300 rounded-2xl'/>
          </div>          
    </div>
