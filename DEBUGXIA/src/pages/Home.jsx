  ...
  return (
    ...
    <div className='flex flex-col items-center justify-between gap-10 mt-30'>
      <div className='flex flex-col items-center justify-between gap-8 '>
        <h1 className='font-bold text-7xl tracking-normal'>Your AI <span className='bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent'>Coding Teacher</span></h1>
