  ...
  return (
    <div className=' flex flex-col justify-between ml-20 mt-10 '>
      <div className=' flex flex-col items-start justify-between gap-3 mt-3 ml-5'>
        <div>
          <h1 className='bg-gradient-to-r from-blue-500 to-fuchsia-400 text-shadow-lg bg-clip-text text-transparent tracking-wide font-bold text-4xl'>Code Analyzer</h1>
        </div>
        <div>
          <p className='font-medium text-lg text-gray-300 text-shadow-sm tracking-wide'>
